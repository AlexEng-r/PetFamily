...
namespace PetFamily.VolunteerManagement.Application.DependencyInjection;

public static class Inject
{
    public static IServiceCollection AddVolunteerApplicationInject(this IServiceCollection services)
    {
        services
            .AddCommandHandlers()
            .AddQueryHandlers()
